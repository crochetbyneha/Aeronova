/* ============================================================
   ...
   this file just to add products or change prices.
   ============================================================ */
...
const waDefaultMsg = `Hi ${SITE_CONFIG.brandName}! I'd like to know more about your aircraft.`;
document.getElementById("whatsappChannel").href = waLink(waDefaultMsg);
document.getElementById("gmailChannel").href = `mailto:${SITE_CONFIG.email}`;
...
document.getElementById("dockGmail").href = `mailto:${SITE_CONFIG.email}`;
document.getElementById("dockInsta").href = SITE_CONFIG.instagram;
document.getElementById("dockTiktok").href = SITE_CONFIG.tiktok;

/* ============================================================
   HERO X-RAY VIEWER
   Two stacked images. The interior image is masked with a
   radial gradient centered on the cursor, so wherever you hover
   a circular "x-ray window" reveals the cutaway underneath.
   ============================================================ */
...
stage.addEventListener("mousemove", (e) => {
  ...
  label.textContent = "X-RAY VIEW · INTERIOR";
});
stage.addEventListener("mouseleave", () => {
  label.textContent = "EXTERIOR VIEW";
});
...
/* ============================================================
   ...
   ============================================================ */
const FAQS = [
  { q: "How do I book a charter?", a: "Tap any hotspot on the aircraft or use WhatsApp — send the flight dates, number of passengers, and route, and our team confirms availability within an hour." },
  { q: "How does delivery work for merch?", a: "Physical items (gear, models, apparel) ship through Pathao. Choose 'Buy via Pathao' on any product card and complete checkout there." },
  { q: "How do I track my order?", a: "Head to the Track Order page and enter your NCM tracking number, or use the official NCM tracking link we provide." },
  { q: "Can I pay in installments for a charter package?", a: "Yes, for packages above $5,000 we offer split payments. Ask our team on WhatsApp for a custom plan." },
];
...
function openAiPanel() {
  ...
  if (!aiMessages.children.length) {
    addMsg("bot", `Hi! I'm the AeroNova AI assistant. Ask me about the AeroNova 7's specs, charter prices, or how to track an order.`);
  }
}
