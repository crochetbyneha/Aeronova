...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = `You are the AI assistant embedded on ${context?.brand || "AeroNova"}'s website.
Answer questions about the aircraft, pricing, specs, ordering, and delivery (Pathao) or tracking (NCM) helpfully and briefly (2-4 sentences).
